<template>
  <p class="pb-4 pt-12">Lets go buy some art!</p>
  ...
  <p>Tensor is a marketplace to buy and sell NFTs.</p>
  ...
  <p>
    ...
    Each NFT has a unique identification code that can’t be replicated or copied
    and metadata that can be linked to a variety of things to provide immutable
    proof of ownership. For example, the metadata an NFT contains can be tied to
    digital images, songs, videos, or avatars. It can also be linked to physical
    items, like cars and yachts, or used to give an NFT owner access to
    exclusive merchandise, tickets to live or digital events, or other exclusive
    perks.
  </p>
  ...
  <p>
    <a
      target="_blank"
      href="https://www.tensor.trade/trade/solana_monkey_business"
      >Monkeys</a
    >,
    <a
      target="_blank"
      href="https://www.tensor.trade/trade/famous_fox_federation"
      >foxes</a
    >,
    <a target="_blank" href="https://www.tensor.trade/trade/okay_bears">bears</a
    >,
    <a
      target="_blank"
      href="https://www.tensor.trade/trade/degenerate_ape_academy"
      >apes</a
    >,
    <a target="_blank" href="https://www.tensor.trade/trade/galactic_geckos"
      >geckos</a
    >… we’ve got it all.
  </p>
  ...
  <ol class="list-decimal ml-4">
    <li>
      Visit Magic Eden at
      <a target="_blank" href="https://www.tensor.trade/"
        >https://tensor.trade/</a
      >
    </li>
